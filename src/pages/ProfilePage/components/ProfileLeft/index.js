...
const ProfileLeft = () => {
  return (
    <aside className="col-span-3 rounded-t-3xl overflow-hidden">
      <section className="relative flex flex-col items-center z-0 overflow-hidden bg-[url('../public/image/profile-bg-avatar.png')]   bg-cover pt-[40px] px-[70px] pb-[20px] shadow-[0px_20px_60px_10px_rgba(237,237,246,0.20)] after:content-[''] after:bg-gradient-to-b after:from-[rgba(26,22,46,0)] to-[#1A162E] after:top-0 after:left-0 after:right-0 after:bottom-0 after:absolute after:z-100 ">
        <img
      ...
      <ul className="p-[30px] bg-top-act-group">
